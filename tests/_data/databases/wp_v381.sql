...
--
-- Base de données: `wp_v381`
--

-- --------------------------------------------------------

--
-- Structure de la table `wp_1000_comments`
--

CREATE TABLE IF NOT EXISTS `wp_1000_comments` (
...
--
-- Contenu de la table `wp_1000_comments`
--

INSERT INTO `wp_1000_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
(1, 1, 'Mr WordPress', '', 'http://wordpress.org/', '', '2014-02-16 13:55:45', '2014-02-16 13:55:45', 'Hi, this is a comment.\nTo delete a comment, just log in and view the post&#039;s comments. There you will have the option to edit or delete them.', 0, '1', '', '', 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `wp_1000_posts`
--

CREATE TABLE IF NOT EXISTS `wp_1000_posts` (
...
--
-- Contenu de la table `wp_1000_posts`
--

INSERT INTO `wp_1000_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
(1, 1, '2014-02-16 13:55:45', '2014-02-16 13:55:45', 'Welcome to WordPress. This is your first post. Edit or delete it, then start blogging!', 'Hello world!', '', 'publish', 'open', 'open', '', 'hello-world', '', '', '2014-02-16 13:55:45', '2014-02-16 13:55:45', '', 0, 'http://wordpress-381.dev/?p=1', 0, 'post', '', 1),
(2, 1, '2014-02-16 13:55:45', '2014-02-16 13:55:45', 'This is an example page. It''s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I''m a bike messenger by day, aspiring actor by night, and this is my blog. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin'' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href="http://wordpress-381.dev/wp-admin/">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'publish', 'open', 'open', '', 'sample-page', '', '', '2014-02-16 13:55:45', '2014-02-16 13:55:45', '', 0, 'http://wordpress-381.dev/?page_id=2', 0, 'page', '', 0);
...
(1, 'siteurl', 'http://wordpress-381.dev', 'yes'),
(2, 'blogname', 'Worpress v381', 'yes'),
...
(36, 'home', 'http://wordpress-381.dev', 'yes'),
...
(106, '_transient_twentyfourteen_category_count', '1', 'yes');
...
(1, 'admin', '$P$Bq8dRhHSCYD1Fp1Y5T3xVwZi294Fg71', 'admin', 'admin@example.com', '', '2014-02-16 13:55:44', '', 0, 'admin');
